...
% -------------------------------------------------------------------------
\begin{frame}{It is arithmetic, and by 11:00 you can do it}
...
\begin{frame}{Four things live in your VRAM. You forget one of them.}
  ...
  \begin{itemize}
    ...
    \item \textbf{Overhead / fragmentation}: allocator, CUDA context, workspace.
          Budget $\approx$ 2\,GB and do not worry.
  \end{itemize}
  \vspace{0.6em}
...
\begin{frame}{We measured all three. An engine is worth about 4$\times$.}
  ...
  \begin{itemize}\small
    ...
    \item \textbf{Do not read a winner here.} On a 0.5\,B model you measure
...
\begin{frame}{Start with vLLM. Move only for a reason.}
  ...
  \vspace{1.2em}
  \begin{center}\large
    Do not start with TensorRT-LLM.
  \end{center}
\end{frame}
...
\begin{frame}{\cutbadge{1: cut this first} \; The layer below: Triton, and a training contrast}
  ...
  \vspace{0.6em}
  \begin{center}\small
    This whole frame is Movement 3d. If the talk runs long, remove this
    frame first.
  \end{center}
\end{frame}
\note{One optional slide, and the first to cut. If you are past 30 minutes
